...
public class UICamera : MonoBehaviour
{
    ...
    public static bool IsGuiClick {
        get {
          //  Debug.LogError(hoveredObject != null); 
          //  Debug.LogError(hoveredObject.transform.parent);
            return hoveredObject != null && hoveredObject.transform.parent.name != "GameContext";
        }
    }
