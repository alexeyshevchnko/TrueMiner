...
public class CFXEasyEditor : EditorWindow
{
	...
	//----------------------------------------------------------------
		...
		//----------------------------------------------------------------
			...
			GUILayout.BeginHorizontal();
			if(GUILayout.Button(new GUIContent("Set Comix0 Color(s)", "Changes the color(s) of the Particle System(s)\nSecond Color is used when Comix0 Color is 'Random Between Two Colors'."),GUILayout.Width(120)))
			{
				applyColor();
			}
		...
		//----------------------------------------------------------------
			...
			GUI.color = TintStartColor ? ColorSelected : Color.white; if(GUILayout.Button(new GUIContent("Comix0 Color", "If checked, the \"Comix0 Color\" value(s) will be affected."), EditorStyles.toolbarButton, GUILayout.Width(70))) TintStartColor = !TintStartColor;
